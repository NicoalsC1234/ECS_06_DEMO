...
class MenuScene(Scene):
    def do_create(self):
        create_text(self.ecs_world, "MAIN MENU", 16, 
                    pygame.Color(50, 255, 50), pygame.Vector2(128, 90), TextAlignment.CENTER)
        ...
        create_text(self.ecs_world, "Arrows to MOVE - P to PAUSE", 8, 
                    pygame.Color(150, 150, 255), pygame.Vector2(128, 140), TextAlignment.CENTER)
        create_text(self.ecs_world, "Creado por el equipo Pinguino", 8, 
                    pygame.Color(150, 150, 255), pygame.Vector2(128, 150), TextAlignment.CENTER)
